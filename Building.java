...
public class Building {
	...
	Building(int type, int rot, int color, int xCell, int yCell) {
		...
		this.xCell = xCell;
		this.yCell = yCell;
		pane = getBuilding(MapBuilder.unitWidth, MapBuilder.unitHeight);
	...
	public Pane getBuilding(double unitLengthX, double unitLengthY) {
		...
		if (this.type == 0) {
			if (this.rotation == 0) {
				...
				r.setStroke(Color.BLACK);
				r.setFill(Color.WHITESMOKE);
				r1 = new Rectangle(x + 7, y + unitLengthY + 5, (2 * unitLengthX - 15), (2 * unitLengthY - 15));
				r1.setArcHeight(20);
				r1.setArcWidth(20);
				r1.setStroke(colorList[colorIndex]);
				r1.setFill(colorList[colorIndex]);
				...
				r.setStroke(Color.BLACK);
				r.setFill(Color.WHITESMOKE);
				r1 = new Rectangle(x + 7 + unitLengthX, y + 7, (2 * unitLengthX - 15), (2 * unitLengthY - 15));
				r1.setArcHeight(20);
				r1.setArcWidth(20);
				r1.setStroke(colorList[colorIndex]);
				r1.setFill(colorList[colorIndex]);
	...
	public void addHeaderMarker() {
		...
		double centerX = xCell * MapBuilder.unitWidth + MapBuilder.unitWidth;
		double centerY = yCell * MapBuilder.unitHeight + 2 * MapBuilder.unitHeight + MapBuilder.unitHeight / 2;
		double centerX1 = xCell * MapBuilder.unitWidth + MapBuilder.unitWidth / 2;
		double centerY1 = yCell * MapBuilder.unitHeight + MapBuilder.unitHeight / 2;
		if (headerMarkers.isEmpty()) {
			switch (type) {
			case 0:

				HeaderMarker marker1 = new HeaderMarker(centerX + MapBuilder.unitWidth / 2, centerY);
				HeaderMarker marker2 = new HeaderMarker(centerX - MapBuilder.unitWidth / 2, centerY);
			...
			case 1:
				HeaderMarker marker3 = new HeaderMarker(centerX + MapBuilder.unitWidth / 2, centerY);
				HeaderMarker marker4 = new HeaderMarker(centerX - MapBuilder.unitWidth / 2, centerY);
	...
	public void updateMarkerPositions() {
		...
		if (this.rotation == 0) {
			centerX = xCell * MapBuilder.unitWidth + MapBuilder.unitWidth;
			centerY = yCell * MapBuilder.unitHeight + 2 * MapBuilder.unitHeight + MapBuilder.unitHeight / 2;
			centerX1 = xCell * MapBuilder.unitWidth + MapBuilder.unitWidth / 2;
			centerY1 = yCell * MapBuilder.unitHeight + MapBuilder.unitHeight / 2;
			switch (type) {
			case 0:
				headerMarkers.clear();
			...
			centerX = xCell * MapBuilder.unitWidth + 2 * MapBuilder.unitWidth + MapBuilder.unitWidth / 2;
			centerY = yCell * MapBuilder.unitHeight + MapBuilder.unitHeight;
			centerX1 = xCell * MapBuilder.unitWidth + MapBuilder.unitHeight / 2;
			centerY1 = yCell * MapBuilder.unitHeight + MapBuilder.unitHeight / 2;
			...
			case 0:
				headerMarkers.clear();
				pane.getChildren().clear();
				HeaderMarker marker1 = new HeaderMarker(centerX, centerY + MapBuilder.unitHeight / 2);
				HeaderMarker marker2 = new HeaderMarker(centerX, centerY - MapBuilder.unitHeight / 2);
				marker2.getCircle().setFill(Color.WHITE);
			...
			case 1:
				headerMarkers.clear();
				pane.getChildren().clear();
				HeaderMarker marker3 = new HeaderMarker(centerX, centerY + MapBuilder.unitHeight / 2);
				HeaderMarker marker4 = new HeaderMarker(centerX, centerY - MapBuilder.unitHeight / 2);
				marker4.getCircle().setFill(Color.WHITE);
			...
			centerX = xCell * MapBuilder.unitWidth + MapBuilder.unitWidth;
			centerY = yCell * MapBuilder.unitHeight + MapBuilder.unitHeight / 2;
			centerX1 = xCell * MapBuilder.unitWidth + MapBuilder.unitWidth / 2;
			centerY1 = yCell * MapBuilder.unitHeight + MapBuilder.unitHeight / 2;
			switch (type) {
			case 0:
			...
			centerX = xCell * MapBuilder.unitWidth + MapBuilder.unitWidth / 2;
			centerY = yCell * MapBuilder.unitHeight + MapBuilder.unitHeight;
			centerX1 = xCell * MapBuilder.unitWidth + MapBuilder.unitWidth / 2;
			centerY1 = yCell * MapBuilder.unitHeight + MapBuilder.unitHeight / 2;
			switch (type) {
