...
public class RoadTile extends Node{
	private int type;
	...
	public RoadTile(int type, int rotation, int xCell, int yCell, double unitWidth, double unitHeigth) {
		...
		case 0:
			...
			if (rotation== 0 || rotation==180) {
				Rectangle rectangle = new Rectangle(xCell* unitWidth,
						yCell*unitHeight + 5, unitWidth, unitHeight - 10);
				rectangle.setFill(Color.WHITE);

				pane.getChildren().add(rectangle);
			} else if (rotation==90||rotation==270) {
				Rectangle rectangle = new Rectangle(xCell* unitWidth + 5,
						yCell*unitHeight, unitWidth - 10, unitHeight);
				rectangle.setFill(Color.WHITE);
				pane.getChildren().add(rectangle);
			}
		...
		case 1:
			...
			if (rotation == 0) {
				Arc arc = new Arc(xCell* unitWidth, (yCell+1) * unitHeight, unitWidth - 5,
						unitHeight - 5, 0, 90);
				...
				Arc arc = new Arc((xCell+1) * unitWidth, (yCell+1) * unitHeight, unitWidth - 5, unitHeight - 5, 90, 90);
				...
				Arc arc = new Arc((xCell+1) * unitWidth, yCell*unitHeight, unitWidth - 5,
						unitHeight - 5, 180, 90);
				...
				Arc arc = new Arc(xCell* unitWidth, yCell*unitHeight,
						unitWidth - 5, unitHeight - 5, 270, 90);
				Arc arc1 = new Arc(xCell* unitWidth, yCell*unitHeight, 5,
						5, 270, 90);
		...
		case 2:
			...
			Rectangle rectangle = new Rectangle(xCell* unitWidth,
					yCell*unitHeight + 5, unitWidth, unitHeight - 10);
			Rectangle rectangle1 = new Rectangle(xCell* unitWidth + 5,
					yCell*unitHeight, unitWidth - 10, unitHeight);
		...
		case 3:
			...
			if (rotation == 0) {
				Rectangle rect = new Rectangle(xCell* unitWidth,
						yCell*unitHeight + 5, unitWidth, unitHeight - 10);
				Rectangle rect1 = new Rectangle(xCell* unitWidth + 5,
						yCell*unitHeight + 5, unitWidth - 10, unitHeight - 5);
				...
				Rectangle rect1 = new Rectangle(xCell* unitWidth + 5,
						yCell*unitHeight, unitWidth - 10, unitHeight);
				Rectangle rect = new Rectangle(xCell* unitWidth,
						yCell*unitHeight + 5, unitWidth - 5, unitHeight - 10);
				...
				Rectangle rect = new Rectangle(xCell* unitWidth,
						yCell*unitHeight + 5, unitWidth, unitHeight - 10);
				Rectangle rect1 = new Rectangle(xCell* unitWidth + 5,
						yCell*unitHeight, unitWidth - 10, unitHeight - 5);
				...
				Rectangle rect1 = new Rectangle(xCell* unitWidth + 5,
						yCell*unitHeight, unitWidth - 10, unitHeight);
				Rectangle rect = new Rectangle(xCell* unitWidth + 5,
						yCell*unitHeight + 5, unitWidth - 5, unitHeight - 10);
	...
	public void updateMarkerPositions() {
        ...
        case 2:
        case 3:
	    pane.getChildren().removeAll(markers.get(0).getCircle(),markers.get(1).getCircle(),markers.get(2).getCircle(),markers.get(3).getCircle());
	  markers.clear();
	    break;
       
        case 1:
        	 pane.getChildren().removeAll(markers.get(0).getCircle(),markers.get(1).getCircle(),markers.get(2).getCircle(),markers.get(3).getCircle()
    , markers.get(4).getCircle(),markers.get(5).getCircle());
        	 markers.clear();
